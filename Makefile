#arm-none-eabi-gcc -mcpu=cortex-m7 -mthumb -mfloat-abi=hard  -mfpu=fpv5-d16 -Wall -fdata-sections -ffunction-sections -Wattributes -Wdouble-promotion -Wno-unused-variable -Wno-write-strings   build/*.o
...
CFLAGS = $(MCU) $(C_DEFS) $(C_INCLUDES) $(OPT) -Wall -fdata-sections -ffunction-sections -Wattributes -Wdouble-promotion -Wno-unused-variable -Wno-write-strings -std=c99 -fshort-wchar
...
lib32blit-stm32:
	echo make PREFIX=$(PREFIX) -C ../32blit	
