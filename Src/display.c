...
//#include "display.hpp"
 ...
 char __ltdc_start, __ltdc_end;
 char __fb_start, __fb_end;
...
void flip(void) {
  SCB_CleanInvalidateDCache_by_Addr((uint32_t *)(g_surface_data), 320 * 240 * 3);
  ...
  DMA2D->FGMAR = (uintptr_t)g_surface_data;
